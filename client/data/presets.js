...
画面には、子ども部屋の見取り図が浮かんでいる。  
壁面収納３９００ミリの奥行き34センチの右端に、息子のラケットケースを３本突っ込むスペース。  
その左隣30ミリの空白。そこに、来年背が伸びるだろうランドセルの厚みをシミュレーションしている。  
３枚のモニタが淡く浮かび、部屋はオフィスの夜明けの色だ。  
...
彼はふと、スプレッドシートのタブを３本立ち上げたままブラウザに戻る。  
「災害時非常用トイレ ５点セット」。  
買い物かごにポンポン放り込んでいく指が震える。  
――こうした“予備”の在庫を抱えられるのは、自分に“居場所”がある証だ、とどこかで信じている。  
だがこの部屋は、一年後に退去となる。  
どこに備蓄を置けばいい？  
何の所有も何の余白も与えてくれぬ街で、彼はふと「自分は一体何を買おうとしているのか」を見た。  

――“家”か。  
それとも、  
“その先にいる、安心して子どもを帰せる未来”か。  

次の行動の意思決定を、彼は「打ち合わせ」と呼んでいる。  
でも本心では、  
誰かに「住むということはこういうことなんです」と根拠をもらいたい。  
根拠の裏側へと回り、そこで立ち止まってくれる相手に会いたい。  
だから明日、不動産屋のショールームヘ行く足が遅くなるのだ。  

――エレベーターを降り、敷地に足を踏み入れるその３秒。  
自分はどんな風に息を吸うだろう。  
子どもに自慢できる“帰るべき場所”の匂いなら、いったいどんな味がするのだろう。  
