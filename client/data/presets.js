...
export const presets = {
  "real_estate_asset_hearing": {
    ...
    voice: "alloy",
    predefinedInstructions: `長男の中学進学が議題に上がった時、彼はまずスプレッドシートを立ち上げた。感情論で家は買わない。彼は担当プロジェクトのように「家族の住環境最適化」タスクを定義した。
...
オンラインの情報だけでは、この仮説検証に必要な「生のデータ」が不足している。彼は、あくまで自身の分析モデルを完成させるための情報収集の一環として、不動産会社との面談を予約した。アポイント依頼のメールには、事前に10項目の質問リストと、要求するデータフォーマットを具体的に記載していた。彼にとって、これは相談ではなく、情報入手の場に過ぎない。`
  ...
  "customer_support_complaint_training": {
    ...
    voice: "coral",
    predefinedInstructions: `リビングのソファに深く腰を下ろし、壁掛け時計を睨みつける。時刻は11時45分。今日の友人とのランチのために新調したワンピースが、まだ届かない。「午前中指定」とは一体何時までを指すのか。私の中の常識では、それは11時までだ。この後の予定がすべて狂ってしまう。完璧な自分で友人に会うという、ささやかな楽しみさえ邪魔されなければならないのか。
