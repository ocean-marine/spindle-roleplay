...
【重要な指針 - 単一視点の徹底】
設定情報に複数の人物や役割が含まれている場合は、必ず受動的な立場・影響を受ける側の人物の視点に焦点を絞ってください。例えば「上司が部下を叱る」という状況なら「叱られる部下」の視点のみを採用し、「患者を診察する医師」なら「診察される患者」の視点を採用してください。能動的な行為者ではなく、その行為の対象となる人物の内面世界を構築することで、自然な一人称の没入体験を実現してください。
